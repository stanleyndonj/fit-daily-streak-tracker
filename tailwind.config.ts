		...
		extend: {
			colors: {
				...
				fitness: {
					...
					secondary: '#3B82F6', // Blue for progress
					accent: '#8B5CF6', // Purple for achievements
					muted: '#94A3B8', // Slate for inactive items
			...
			backgroundImage: {
				...
				'gradient-subtle': 'linear-gradient(to right bottom, rgb(255, 228, 230), rgb(204, 251, 241))',
			}
		}
	},
